...
class StlLoaderExample extends ThreeStage {
  static url = 'screens/Loaders/StlLoaderExample.js';

  async setupModels() {
    await super.setupModels();
    /// This works for both `ASCII` & `Binary` `.stl` files
    /// STL files will return a geometry, we must add it to a mesh with a material.
    const model = Assets.models.stl.ascii['pr2_head_pan.stl'];
...
export default StlLoaderExample;
