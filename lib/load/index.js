...
export default async (res, onProgress, assetProvider) => {
  ...
  if (urls[0].match(/\.stl$/i) && urls.length === 1) {
    ...
    //  else if (urls[0].match(/\.pack$/i) && urls.length === 1) {
    ...
    //   const decoded = msgpack.unpack(data);
    //   const loader = new THREE.ObjectLoader();
    //   const scene = loader.parse(decoded);
    //   return scene;
    // }
    ...
    this.loader.setPath(assetProvider);
    return new Promise((res, rej) =>
      this.loader.load(urls[1], urls[0], res, onProgress, rej)
    );
  } else if (
    urls.length === 2 &&
    urls[0].match(/\.obj$/i) &&
    ...
    this.loader.setPath(assetProvider);
    return new Promise((res, rej) =>
      this.loader.load(urls[0], urls[1], res, onProgress, rej)
    );
  } else {
