...
export declare function hitTestWithFeatures(camera: ARCamera, point: THREE.Vector2, coneOpeningAngleInDegrees: number, minDistance?: number, maxDistance?: number, maxResults?: number, rawFeaturePoints?: any[]): any[] | undefined;
export declare function hitTestWithPoint(camera: ARCamera, point: THREE.Vector2): any[];
...
export declare function convertTransformArray(transform: Array<number>): THREE.Matrix4;
export declare function positionFromTransform(transform: THREE.Matrix4): THREE.Vector3;
export declare function worldPositionFromScreenPosition(camera: ARCamera, position: THREE.Vector2, objectPos: THREE.Vector3, infinitePlane?: boolean, dragOnInfinitePlanesEnabled?: boolean, rawFeaturePoints?: any): {
    worldPosition: any;
    planeAnchor: any;
    hitAPlane: boolean;
} | {
